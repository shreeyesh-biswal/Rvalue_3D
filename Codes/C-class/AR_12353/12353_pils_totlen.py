...
colorbarticks = [0, 60, 120, 180, 240, 300]
cbar_min = 0
cbar_max = 300
flare_time1 = 51.45
flare_time2 = 55.30
...
axs[0].text(-3, (cbar_max + (0.35*(cbar_max - cbar_min))), P1, fontsize=23)
axs[5].text(-39, 0.5*(cbar_max - cbar_min), 'Height (Mm)', rotation = 90, fontsize=18)
