...
colorbarticks = [0, 120, 240, 360, 480, 600]
cbar_min = 0
cbar_max = 600
flare_time = 161.58
...
axs[0].text(-5, (cbar_max + (0.35*(cbar_max - cbar_min))), P1, fontsize=23)
axs[5].text(-60, cbar_min + 0.5*(cbar_max - cbar_min), 'Height (Mm)', rotation = 90, fontsize=18)
axs[9].text(27, (cbar_min - (0.65*(cbar_max - cbar_min))), 'Time after ' + start_time + ' (hrs)', rotation = 0, fontsize=18)
