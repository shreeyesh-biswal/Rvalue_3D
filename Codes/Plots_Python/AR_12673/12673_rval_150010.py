...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  8 20:55:12 2023
...
for i in range(0,m):
    ...
    axs[i].axvline(x = flare_time3, ymin = 0, ymax = 1, linestyle = '--', color = 'k', alpha=0.40) # Show heights in the altitude
...
axs[9].text(-12, (cbar_min - (0.65*(cbar_max - cbar_min))), 'Time after ' + start_time + ' (hrs)'  + '; ($B_{th}$, $D_{sep}$) = ' + '(' + th + ',' + d + ')', rotation = 0, fontsize=18)
